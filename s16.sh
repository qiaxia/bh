...
export NEZHA_KEY=${NEZHA_KEY:-'rxU9hIOu1vffZFb6oI'} 
export ARGO_DOMAIN=${ARGO_DOMAIN:-'s16.62551118.xyz'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiNWJmMzNlYjI4MjQ3NjMxYjVhZDQ0M2I4MTk4ZTBjYmEiLCJ0IjoiYzdhMmU5ZDctZjllYy00Y2M3LWFjNGEtNTRlOGE3Mzg0MzBiIiwicyI6IlpETmhZVFF4TVdVdFlqVm1NeTAwWkdReExXSTVNREF0WTJJM016WXdZemxoWldFdyJ9'}
export VMESS_PORT=${VMESS_PORT:-'13608'}
export TUIC_PORT=${TUIC_PORT:-'21091'}
export HY2_PORT=${HY2_PORT:-'63703'}
export CFIP=${CFIP:-'www.visa.com.tw'} 
export CFPORT=${CFPORT:-'443'} 
export SBip=${SBip:-'207.180.248.6'}
